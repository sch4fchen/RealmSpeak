...
public class QuestRequirementEditor extends QuestBlockEditor {
	...
	protected ArrayList<QuestPropertyBlock> createPropertyBlocks() {
		...
		switch (requirement.getRequirementType()) {
			...
			case Clearing:
				...
				list.add(new QuestPropertyBlock(QuestRequirementClearing.TILE_NO_MARK_REQUIRED, "Tile must have no mark", FieldType.Boolean));
				...
				list.add(new QuestPropertyBlock(QuestRequirementClearing.CHIT_NO_MARK_REQUIRED, "Chit must have no mark", FieldType.Boolean));
				list.add(new QuestPropertyBlock(QuestRequirementClearing.CHIT_ADD_MARK, "Add mark to chit", FieldType.Boolean));
				list.add(new QuestPropertyBlock(QuestRequirementClearing.CHIT_REMOVE_MARK, "Remove mark of chit", FieldType.Boolean));
				break;
			case ColorMagic:
			...
			case DiscoveryPathsPassagesOfLocation:
				...
				list.add(new QuestPropertyBlock(QuestRequirementDiscoveryPathsPassagesOfLocation.PATHS, "Hidden Paths", FieldType.Boolean));
				list.add(new QuestPropertyBlock(QuestRequirementDiscoveryPathsPassagesOfLocation.PASSAGES, "Secret Passages", FieldType.Boolean));
	...
	private String[] getAllTileTypes() {
		...
		choices.add(QuestConstants.ANY);
		choices.addAll(list);
	...
	private String[] getAllChitTypes() {
		...
		choices.add(QuestConstants.NONE);
		choices.addAll(list);
