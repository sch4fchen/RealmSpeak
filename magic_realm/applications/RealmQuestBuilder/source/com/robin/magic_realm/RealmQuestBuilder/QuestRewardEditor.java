	...
	protected ArrayList<QuestPropertyBlock> createPropertyBlocks() {
		...
		switch (reward.getRewardType()) {
			...
			case MarkTraveler:
				...
				list.add(new QuestPropertyBlock(QuestRewardMarkTraveler.CHOOSE_TRAVELER, "Choose traveler", FieldType.Boolean));
				list.add(new QuestPropertyBlock(QuestRewardMarkTraveler.RANDOM_TRAVELER, "Random traveler", FieldType.Boolean));
				list.add(new QuestPropertyBlock(QuestRewardMarkTraveler.CHARACTERS_CLEARING, "In characters clearing only", FieldType.Boolean));
			...
			case MoveDenizen:
				...
				list.add(new QuestPropertyBlock(QuestRewardMoveDenizen.MARK, "Requires mark", FieldType.Boolean));
