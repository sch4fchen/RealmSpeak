...
public class QuestRewardClonedQuestsCounter extends QuestReward {
	...
	public QuestRewardClonedQuestsCounter(GameObject go) {
		super(go);
	}
	...
	private void processCounter(QuestCounter counter) {
	...
	public RewardType getRewardType() {
		return RewardType.ClonedQuestsCounter;
	}
