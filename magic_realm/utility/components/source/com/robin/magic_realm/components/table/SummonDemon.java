...
public class SummonDemon extends RealmTable {
	...
	public SummonDemon(JFrame frame,GameObject caster,Speed attackSpeed) {
		super(frame,null);
		this.caster = caster;
	...
	public static SummonDemon doNow(JFrame parent,GameObject attacker,GameObject target,boolean casterRolls,int redDie,Speed attackSpeed) {
		SummonDemon pop = new SummonDemon(parent,attacker,attackSpeed);
