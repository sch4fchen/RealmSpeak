...
//				usedObjects.addAll(list);
	...
	public boolean canAddAction(String fullAction,boolean pony,JFrame parent) {
		...
		TileLocation newLocation = null;
		if (movePhase && !"M".equals(fullAction) && !"M,M".equals(fullAction) && !"M,M,M".equals(fullAction) && !"M,M,M,M".equals(fullAction)) { // no new location, if testing for move action M in general
